...
\item Generated solutions to previously-unidentified curricular issues.
\end{compactitem}
...
\begin{compactitem}
\item Maintained communication between students and faculty as the regional campus implemented plans to sunset the college.
...
\cvitem{Statistics}{Basic hypothesis testing, single and multiple linear regression, ANOVA, clustering analysis, PCA.}
\cvitem{Image analysis}{Automated high-content image cytometry (ImageJ, CellProfiler).}

\section{Interests}
Reading, programming, viola, aikido, biking, weight lifting.
